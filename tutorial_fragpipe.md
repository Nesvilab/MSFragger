...
a. Load the selected TMT/iTRAQ channels.
...
3. If you have multiple plexes and want to use a Bridge channel, select 'Define reference: Reference sample', and enter the text keyword describing the Bridge channel (e.g. 'pool') that matches your naming scheme. Alternatively, use 'Virtual' reference sample approach.   
