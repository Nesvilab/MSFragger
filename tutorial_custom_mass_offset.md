...
### Examine the results
Inspect the global.profile.tsv file. Explore the results. Do you observe the mass shifts discussed in the [manuscript](doi.org/10.1016/j.cell.2018.11.004) (Figure 2B, shown below)? What are the mapped_mass_1 names given to the top two entries? Do these two mass shifts each predominantly localize to a particular residue(s)? Does the annotation (mapped_mass_1 name) of the top mass shift show up elsewhere in this file?
